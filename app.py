...
def calculator_results():
    ...
    context = {
        'operand_1': int(request.args.get('operand1')),
        'operand_2': int(request.args.get('operand2')),
        'operation': request.args.get('operation'),
    }
    operand_1 = context['operand_1']
    operand_2 = context['operand_2']
